function [gbest, gbestval, hist_v, hist_p, fitcount]= PID_PSO_func(fhd, Dimension, Particle_Number, Max_iters, VRmin, VRmax, varargin)
...
%     der = zeros(Num_Ptcs, D);
    vv_last = zeros(Num_Ptcs, D);
    %vv_last2 = zeros(Num_Ptcs, D);
