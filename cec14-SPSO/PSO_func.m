function [gbest,gbestval,hist_v,hist_p,fitcount]= PSO_func(fhd,Dimension,Particle_Number,Max_Gen,VRmin,VRmax,varargin)
...
iwt=double(0.9-(1:double(me)).*(0.5./double(me)));
