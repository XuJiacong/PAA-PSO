function [gbest,gbestval,hist_v,hist_p,FES]= PBS_HCLPSO_func(fhd,dimension,num_particle,max_iters,VRmin,VRmax,varargin) 
...
for k = 1:me-1
        ...
        der(1:num_g1,:) = alpha*der(1:num_g1,:) + (gbestrep(1:num_g1,:)-last_gbest(1:num_g1,:));
       ...
       % group 2
        ...
        der(num_g1+1:end,:) = alpha*der(num_g1+1:end,:) + (gbestrep(num_g1+1:end,:)-last_gbest(num_g1+1:end,:));
