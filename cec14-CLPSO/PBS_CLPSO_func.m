function [gbest,gbestval,hist_v,hist_p,fitcount]= PBS_CLPSO_func(fhd,Dimension,Particle_Number,Max_Gen,VRmin,VRmax,varargin)
    ...
    for i = 2 : me
        for k = 1 : ps
            ...
            der(k, :) = alpha.*der(k, :) + (gbest - gbest_last);
            gbest_last = gbest;
